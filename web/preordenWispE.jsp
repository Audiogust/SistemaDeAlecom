<%-- 
    Document   : preordenWispE
    Created on : 13-feb-2022, 23:54:06
    Author     : Hp
--%>
 ...
 body {
        ...
        <center>
            ...
            <table align="center" border="5" width="50%" class="table table-light table-bordered table-hover table-responsive-sm">
  	                 <thead class="bg-info"> 
                            ...
                            <%
                             ...
                             <tr <% if (objs.getExistencia() <= r) { %> class="table-danger" <%}%> >
                                 ...
                                 <td><%= objs.getIden()%> <input  type="hidden" value="<%= objs.getIden()%>" name="codC"></td>
                ...
                <button id ="botonSi" style="display: none" type="submit" name="opcion" value="botonPreordenAccionE" class="btn btn-success">Generar</button>
