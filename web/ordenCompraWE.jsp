<%-- 
    Document   : ordenCompraWE
    Created on : 15-feb-2022, 13:57:06
    Author     : Hp
--%>
 ...
 <div align="center">                    
    ...
    <center>
        <form action="controlClientes.do" method="post">
            ...
            <button type="submit" name="opcion" value="autorizarExistenciaEqui" class="btn btn-success">validar Materiales</button>
