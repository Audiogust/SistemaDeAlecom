<%-- 
    Document   : ordenCompraWispE
    Created on : 15-feb-2022, 12:36:36
    Author     : Hp
--%>
  	                 ...
  	                 <thead class="bg-info"> 
                            ...
                            <%                         
                             ...
                             <tr>
                                ...
                                <td><%= objs.getOtiga()%></td>
                                <td><%= objs.getFolio()%></td>
                                <td align="center" ><a href="ordenCompraWE.jsp?txtpara=M&id=<%= objs.getFolio()%>">
