<%-- 
    Document   : HistorialSalidaw
    Created on : 18-jun-2021, 11:40:14
    Author     : Hp
--%>
...
<html>
    ...
    <body>
       <div align="center">                   
                ...
                <h1>Historial Salida de Material</h1>
            </div> 
  	                 ...
  	                 <thead class="bg-info"> 
                            ...
                            <%
                             ...
                             <tr>
                                ...
                                <td align="center" ><a href="HistorialSalMw.jsp?txtpara=M&id=<%= objs.getId()%>">
