<%-- 
    Document   : foliosOrdenCompra
    Created on : 28-ago-2021, 15:10:18
    Author     : Hp
--%>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body>
        <div class="table-responsive" align="center">
            ...
            <h1>Historiales Folios Orden de Precompras</h1>
        </div>
  	                 ...
  	                 <thead class="bg-info"> 
                            ...
                            <%                         
                             ...
                             <tr>
                                ...
                                <td><%= objs.getOtiga()%></td>
                                <td><%= objs.getFolio()%></td>
                                <td align="center" ><a href="tablaFolioOrdenCompra.jsp?txtpara=M&id=<%= objs.getFolio()%>">
